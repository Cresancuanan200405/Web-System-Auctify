...
export const BecomeSellerSection: React.FC = () => {
    ...
    const [submitBusinessMode, setSubmitBusinessMode] = useState<
        'now' | 'later'
    >('now');
    ...
    const [primaryDocumentType, setPrimaryDocumentType] =
        useState('DTI Certificate');
    ...
    const [submitSwornDeclaration, setSubmitSwornDeclaration] = useState<
        'yes' | 'no' | ''
    >('');
    ...
    const goNext = () => {
        setStep((current) =>
            current === 3 ? 3 : ((current + 1) as 1 | 2 | 3),
        );
    };
    ...
    useEffect(() => {
        ...
        const loadRegions = async () => {
            try {
                ...
                console.error(
                    'Failed to load regions for pickup address:',
                    error,
                );
            }
        };
    ...
    const handleRegionSelect = async (regionCode: string) => {
        ...
        try {
            ...
            console.error(
                'Failed to load provinces for pickup address:',
                error,
            );
        }
    };
    ...
    const handleCitySelect = async (cityCode: string) => {
        ...
        try {
            ...
            console.error(
                'Failed to load barangays for pickup address:',
                error,
            );
        }
    };
    ...
    const handleSavePickupAddress = async () => {
        ...
        if (
            ...
            toast.error(
                'Please complete the region, province, city, and barangay fields.',
            );
            return;
        }
        ...
        try {
            ...
            const errorMessage =
                responseMessage || 'Failed to save pickup address.';
    ...
    const handleSubmitSellerRegistration = async () => {
        ...
        try {
            ...
            toast.error(
                responseMessage || 'Failed to submit seller registration.',
            );
        } finally {
    ...
    const navigateToSellerProductListing = () => {
        ...
        if (!popup) {
            toast.info(
                'Please allow pop-ups to open Add Product in a new tab.',
            );
        }
    };
            ...
            <div className="seller-main">
                <div className="seller-card">
                    ...
                    <h2 className="seller-title">
                        Welcome to AUCTIFY Seller Center
                    </h2>
    ...
    return (
        <div className="seller-main">
            <div className="seller-form-card">
                <div
                    className="seller-form-steps"
                    aria-label="Seller registration steps"
                >
                    <div className="seller-form-step-row">
                        ...
                        >
                            ...
                            <span className="seller-step-label">
                                Shop Information
                            </span>
                        </button>
                            ...
                            {step === 1 && (
                                <div className="seller-form-section">
                                    ...
                                    <p className="seller-hint">
                                        Tell buyers who you are and how they can
                                        reach you. You can always update these
                                        details later.
                                    </p>
                                    <div className="seller-form-row">
                                        <label className="seller-label">
                                            <span className="seller-label-required">
                                                *
                                            </span>{' '}
                                            Shop Name
                                        </label>
                                    ...
                                    <div className="seller-form-row">
                                        ...
                                        <p className="seller-hint">
                                            This is where couriers will collect
                                            items for your auctions.
                                        </p>
                                    </div>
                            ...
                            {step === 2 && (
                                <div className="seller-form-section">
                                    ...
                                    <div className="seller-info-banner">
                                        This information is used for invoicing
                                        and compliance. You can still submit now
                                        and complete missing details later.
                                    </div>
                                    ...
                                    <h4 className="seller-subsection-title">
                                        Entity Information
                                    </h4>
                                    ...
                                    {(sellerType === 'corp' ||
                                        ...
                                        <div className="seller-form-row">
                                            ...
                                            <div className="seller-input-wrap">
                                                ...
                                                />
                                                <div className="seller-inline-counter">
                                                    {
                                                        companyRegisteredName.length
                                                    }
                                                    /255
                                                </div>
                                                <p className="seller-hint seller-inline-hint">
                                                    Company Registered Name is
                                                    your business&apos;s
                                                    official designation,
                                                    recorded with government
                                                    authorities for legal, tax,
                                                    and formal transactions.
                                                </p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div className="seller-form-row">
                                        <label className="seller-label">
                                            Primary Business Document Type
                                        </label>
                                        <div className="seller-input-wrap">
                                            <select
                                                className="seller-input"
                                    ...
                                    <div className="seller-form-row seller-otp-row">
                                        ...
                                        <div className="seller-otp-wrap">
                                            ...
                                            <button
                                                type="button"
                                                className="seller-primary-btn seller-otp-verify"
                                            >
                                                Verify
                                            </button>
                                        </div>
                        ...
                        <div className="seller-form-actions">
                            ...
                            <div className="seller-form-actions-right">
                                ...
                                <button
                                    ...
                                    disabled={
                                        (step === 2 && !agreeBusinessTerms) ||
                                        (step === 3 && isSubmittingSeller)
                                    }
                                >
                                    {step === 3
                                        ? isSubmittingSeller
                ...
                >
                    ...
                    >
                        <div className="seller-address-modal-header">
                            <h3 className="seller-address-modal-title">
                                Add a new address
                            </h3>
                            <button
                                type="button"
                        ...
                        <div className="seller-address-modal-body">
                            ...
                            <div className="field">
                                ...
                                <div className="seller-location-panel">
                                    {locationStep === 'region' && (
                                        <>
                                            <p className="seller-location-help">
                                                Choose your region.
                                            </p>
