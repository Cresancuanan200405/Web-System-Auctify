...
export const WalletSection: React.FC = () => {
    ...
    const [pendingMainCardId, setPendingMainCardId] = useState<number | null>(
        null,
    );
    ...
    const confirmMainCardChange = () => {
        ...
        const targetCard = savedCards.find(
            (card) => card.id === pendingMainCardId,
        );
        if (!targetCard) {
            setPendingMainCardId(null);
            return;
        ...
        <div className="wallet-main">
            ...
            {savedCards.length > 0 && (
                <div className="wallet-cards-section">
                    <h3 className="wallet-cards-title">
                        Select Main Card for Transactions
                    </h3>
            ...
            {savedCards.length === 0 && (
                <div className="wallet-empty-state">
                    <p>
                        No cards added yet. Add a card in the "My Cards" section
                        to get started.
                    </p>
                </div>
            )}
            ...
            <div className="wallet-code-card">
                <div className="wallet-code-header">
                    ...
                    <div className="wallet-code-title">
                        Have a store credit code?
                    </div>
                </div>
                            ...
                            <div className="wallet-info-content">
                                <div className="wallet-info-section">
                                    ...
                                    <p className="wallet-info-text">
                                        My Wallet is your centralized payment
                                        hub on Auctify. It displays the
                                        available balance from your main card
                                        and allows you to manage which payment
                                        method you want to use for transactions.
                                    </p>
                                </div>
                                ...
                                <div className="wallet-info-section">
                                    ...
                                    <p className="wallet-info-text">
                                        Your wallet balance shows the available
                                        credit from your currently selected main
                                        card. This is the amount you can use to
                                        bid on auctions and make purchases on
                                        Auctify.
                                    </p>
                                </div>
                                ...
                                <div className="wallet-info-section">
                                    ...
                                    <p className="wallet-info-text">
                                        You can select which card you want to
                                        use as your main payment method. All
                                        your transactions on Auctify will use
                                        your main card's balance. Simply click
                                        on a card from your saved cards to set
                                        it as your main card.
                                    </p>
                                </div>
                                ...
                                <div className="wallet-info-section">
                                    ...
                                    <p className="wallet-info-text">
                                        Auctify supports multiple payment
                                        methods:
                                    </p>
                                ...
                                <div className="wallet-info-section">
                                    ...
                                    <p className="wallet-info-text">
                                        If you have a store credit code from
                                        Auctify, you can redeem it in your
                                        wallet. Enter the code and click Apply
                                        to add the credit to your selected main
                                        card.
                                    </p>
                                </div>
                                ...
                                <div className="wallet-info-section">
                                    ...
                                    <ul className="wallet-info-list">
                                        <li>
                                            Your wallet automatically reflects
                                            updates to your selected card's
                                            balance
                                        </li>
                                        <li>
                                            You must have at least one saved
                                            card in "My Cards" to use your
                                            wallet
                                        </li>
                                        <li>
                                            Changing your main card will affect
                                            future transactions
                                        </li>
                                        <li>
                                            All transaction history can be
                                            viewed in your account details
                                        </li>
                                    </ul>
                                </div>
                            </div>
